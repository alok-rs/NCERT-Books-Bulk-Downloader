    ...
    #name or url
        ...
        #book url
            ...
            try:
                ...
                g = m.groups(0)
                code = g[0]
                print (g_class + '/' + g_subject + '/' + g_book + '|https://ncert.nic.in/textbook/pdf/' + code + 'ps.pdf')
                for i in range(1, int(g[1])+1):
                    chapter = i
                    print (g_class + '/' + g_subject + '/' + g_book + '|https://ncert.nic.in/textbook/pdf/' + code + '%02d' % i + '.pdf')
            except:
                pass
